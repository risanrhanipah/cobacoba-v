...
error_reporting(0);
  ...
  $sql = mysqli_query($con, "INSERT INTO tb_pengguna VALUES('','$_POST[nama]','$_POST[jabatan]','$_POST[username]', '$_POST[password]')"); 
    if ($sql) { 
        echo "<script>alert('Data berhasil disimpan'); document.location.href='?menu=pengguna';</script>"; 
  }else{ 
        echo "<script>alert('Data Gagal disimpan'); document.location.href='?menu=pengguna';</script>"; 
     } 
 } 
...
<tr>  
      <td>Jabatan</td>   
      <td>:</td>   
      <td><select name="jabatan"><option value="" disabled selected> -- Pilih Jabatan --</option> 
